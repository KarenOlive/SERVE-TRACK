        ...
        <div className="text-center mt-6 pt-6 border-t border-gray-200">
          ...
          <div className="space-y-3">
            <Link 
              ...
              className="block w-full bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition text-center font-medium"
            >
              Register as Student
            </Link>
            <Link 
              href="/register/sites" 
              className="block w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition text-center font-medium"
            >
